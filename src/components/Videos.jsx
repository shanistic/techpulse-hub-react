...
const Videos = () => {
  ...
  return (
    <Stack direction={['column', 'row']} h={'130vh'}>
      <VStack w={'full'}>
        <video
          controls
        ...
        <VStack alignItems={'flex-start'} p={'8'} w={'full'} overflowY={'auto'}>
          ...
          <Text>
            ...
            consectetur rem ex adipisci alias, voluptatem quia ea totam quasi
            minus dolorem, pariatur ducimus exercitationem est neque repellat
            labore facere cumque repudiandae dolorum, iste quam magni ab dicta.
            Nobis illum nam, natus amet iusto hic, ipsum quisquam sapiente
            nesciunt eius dolor?
          </Text>
        </VStack>
      </VStack>
